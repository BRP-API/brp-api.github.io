...
=== 3. Proxy
Voor autorisatie op detailniveau. Met welke rol of taak mag een medewerker of applicatie welke set gegevens opvragen? Hiervoor maak je gebruik van de link:/how-tos/personen-response-filteren[filtermogelijkheden] die de {apiname} biedt. Dit kun je regelen in jouw API Gateway, zoals in link:https://github.com/Amsterdam/haal-centraal-proxy[dit voorbeeld van de gemeente Amsterdam].
