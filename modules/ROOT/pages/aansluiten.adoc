...
Heb je jouw client applicatie gerealiseerd met behulp van de xref:lokaal-testen[BRP API mock], en ben je toe aan de acceptatietest op de omgeving van RvIG?  
