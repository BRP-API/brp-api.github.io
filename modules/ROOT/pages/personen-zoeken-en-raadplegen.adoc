...
* zoek met geslachtsnaam en geboortedatum
  ** link:/personen/features/zoek-met-geslachtsnaam-en-geboortedatum/overzicht[overzicht]
  ** link:/personen/features/zoek-met-geslachtsnaam-en-geboortedatum/fout-cases[fout cases]
* zoek met geslachtsnaam, voornamen en gemeente van inschrijving
  ** link:/personen/features/zoek-met-geslachtsnaam-voornamen-en-gemeente-van-inschrijving/overzicht[overzicht]
  ** link:/personen/features/zoek-met-geslachtsnaam-voornamen-en-gemeente-van-inschrijving/fout-cases[fout cases]
* zoek met postcode en huisnummer
  ** link:/personen/features/zoek-met-postcode-en-huisnummer/overzicht[overzicht]
  ** link:/personen/features/zoek-met-postcode-en-huisnummer/fout-cases[fout cases]
* zoek met straat, huisnummer en gemeente van inschrijving
  ** link:/personen/features/zoek-met-straatnaam-huisnummer-en-gemeente-van-inschrijving/overzicht[overzicht]
  ** link:/personen/features/zoek-met-straatnaam-huisnummer-en-gemeente-van-inschrijving/fout-cases[fout cases]
* zoek met nummeraanduiding identificatie
  ** link:/personen/features/zoek-met-nummeraanduiding-identificatie/overzicht[overzicht]
  ** link:/personen/features/zoek-met-nummeraanduiding-identificatie/fout-cases[fout cases]
* zoek met adresseerbaar object identificatie
  ** link:/personen/features/zoek-met-adresseerbaar-object-identificatie/overzicht[overzicht]
  ** link:/personen/features/zoek-met-adresseerbaar-object-identificatie/fout-cases[fout cases]
...
Van de personen in beide responsetypen krijg je uitsluitend link:./personen-response-filteren[gegevens waar je om vraagt] en waar je recht op hebt.
...
Ben je uitsluitend geautoriseerd voor het zoeken van eigen inwoners van een gemeente? Gebruik dan de queryparameter *gemeenteVanInschrijving* met de eigen gemeentecode. Dan worden inwoners van andere gemeenten automatisch uit het antwoord gefilterd. Ieder van de bovenstaande zoekoperaties biedt de mogelijkheid om deze parameter op te geven. Lees meer informatie over het link:/personen/features/zoeken/binnengemeentelijk[zoeken en raadplegen van alleen binnengemeentelijke personen].

=== Overleden personen zoeken
Standaard worden alleen personen gevonden die in leven zijn. Om overleden personen te vinden, moet je de inclusiefOverleden parameter met waarde "true" opgeven. Lees voor meer informatie het link:/personen/features/zoeken/overleden-personen[zoeken van overleden personen].

Voor overleden personen wordt altijd het opschortingBijhouding veld geleverd met reden code 'O' en omschrijving 'overlijden'. Lees voor meer informatie het link:/personen/features/beperkt/overlijden/overzicht[overlijden overzicht].
...
* raadpleeg met burgerservicenummer
  ** link:/personen/features/raadpleeg-met-burgerservicenummer/overzicht[overzicht]
  ** link:/personen/features/raadpleeg-met-burgerservicenummer/fout-cases[fout cases]

Het resultaat van deze operatie is een lijst van personen van wie het burgerservicenummer overeenkomt met de opgegeven burgerservicenummers. Van deze personen krijg je uitsluitend link:./personen-response-filteren[gegevens waar je om vraagt] en waar je recht op hebt.
...
Voor overleden personen wordt altijd het opschortingBijhouding veld geleverd met reden code 'O' en omschrijving 'overlijden'.  Zie de link:/personen/features/overlijden/overzicht[overlijden overzicht] feature voor meer informatie over dit veld.
