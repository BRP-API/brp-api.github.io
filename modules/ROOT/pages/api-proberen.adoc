...
De API op de probeeromgeving vereist - net als in productie - dat een OAuth token wordt meegestuurd. Hiervoor heb je client credentials nodig. Vraag deze aan door een e-mail te sturen naar mailto:{po-email}[{po-naam}]. Geef in die e-mail aan voor welke organisatie je credentials wilt en geef je contactgegevens op. Die gebruiken we om je te informeren over belangrijke wijzigingen. gepland onderhoud, enz.
...
https://elements.getpostman.com/redirect?entityId=6707821-5940172f-a50a-4a66-b61b-b3bb63fb0287&entityType=collection&workspaceId=fbc0d981-545f-4f19-9ef3-f126d4b4d522[image::https://run.pstmn.io/button.svg[alt="Run In Postman", style="width: 128px; height: 32px;"]
