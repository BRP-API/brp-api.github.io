...
Heb je jouw client applicatie gerealiseerd met behulp van de link:./lokaal-testen[BRP API mock], en ben je toe aan de acceptatietest op de omgeving van RvIG?  
...
* afnemersindicatie: dit is het nummer dat hoort bij je autorisatiebesluit. Dit kun je link:https://publicaties.rvig.nl/Landelijke_tabellen/Zoekpagina_tabel_35_autorisatietabel[hier opzoeken].
...
Test jouw applicatie met link:https://www.rvig.nl/testsetpersoonslijstenproefomgevingBRPV[deze testset]. Samen beoordelen we de aansluiting. Geslaagd? Dan kun je een aansluiting op de productieomgeving aanvragen.

== Aansluiten productie-omgeving

== Voorwaarden
* een door jouw gemandateerde ondertekend link:/how-tos/convenant[convenant]
* een link:https://publicaties.rvig.nl/Besluiten_en_modelautorisaties/Besluiten/BRP_besluiten[BRP autorisatiebesluit] en een aanvullend autorisatiebesluit voor informatieproducten (niet voor gemeenten)
