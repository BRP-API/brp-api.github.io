...
Je kunt er ook voor kiezen om de link:{dev-branch-url}/.k8s[Kubernetes configuratie bestanden] te gebruiken om de {apiname} Personen mock te draaien op een lokale machine.
...
* Download het link:{main-branch-url}/docker-compose.yml[Personen docker compose bestand]
...
* Download de link:{dev-branch-url}/.k8s[Personen kubernetes configuratie bestanden]
